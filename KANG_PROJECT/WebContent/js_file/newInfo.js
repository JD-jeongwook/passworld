...
document.addEventListener("keyup",pwChk);

function pwChk() {
	var pw = document.forms["insert_info"]["pw"].value;
	var pw2 = document.forms["insert_info"]["pw2"].value;
	
	if(pw2.length != 0) {
		if(pw != pw2) {
			document.getElementById("blank").innerHTML="비밀번호가 일치하지 않습니다.";
			return false;
		} else {
