...
<script>
	function okay(c) {
		...
		opener.document.air_form.st_airport.value = airport;
		opener.document.air_form.st_country.value = country;
		window.close();
	}
...
<body>
	...
	<form method='post' action='search_start.do' onsubmit="return getFlag(${ flag })">
