...
LOCK TABLES `user_reserve` WRITE;
/*!40000 ALTER TABLE `user_reserve` DISABLE KEYS */;
INSERT INTO `user_reserve` VALUES (9,'eoen446','대한민국','인천국제공항','영국','리버풀 존 레논 공항','2020-11-20','2020-11-30','진에어',1,0),(11,'male_id','대한민국','인천국제공항','미국','그레이터 로체스터 국제공항','2020-12-17','2020-12-31',NULL,2,0);
/*!40000 ALTER TABLE `user_reserve` ENABLE KEYS */;
UNLOCK TABLES;
